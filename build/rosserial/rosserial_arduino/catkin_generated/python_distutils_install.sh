...
echo_and_run cd "/home/ubuntu/btp_catkin/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/btp_catkin/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/ubuntu/btp_catkin/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
