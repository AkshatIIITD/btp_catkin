...
echo_and_run cd "/home/ubuntu/btp_catkin/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/btp_catkin/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/ubuntu/btp_catkin/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
