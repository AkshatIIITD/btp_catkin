...
echo_and_run cd "/home/ubuntu/btp_catkin/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/btp_catkin/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/ubuntu/btp_catkin/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
