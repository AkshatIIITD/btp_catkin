...
if(NOT "/home/ubuntu/btp_catkin/src/rf2o_laser_odometry/include;/usr/include/eigen3 " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/btp_catkin/src/rf2o_laser_odometry/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/btp_catkin/src/rf2o_laser_odometry/${idir}'.  ${_report}")
    endif()
